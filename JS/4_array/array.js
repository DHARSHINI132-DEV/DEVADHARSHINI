...
// it can take 3 parameters. [it will take one call back function where it can take 3 parameters (element,index,array)]
...
// it will take one call back function where it can take 4 parameters (accumulator,element,index,array)
// accumulator will take the default value as the first element but we can also initialize to a certain value by passing it after the call back function
...
// sort() is a higher order method  and this method is used to arrange the array in ascending or descending order.
...
// 1st parameter - 2nd parameter eill give the array in ascending order
// 2nd parameter - 1st parameter eill give the array in descending order
...
/* here if we are using only a single line then there is no need of return keyword and {} */
console.log(asc)
...
// alter method ----> .operator is used to chain the methods
