...
// 1.toUpperCase()-->used to convert any string into uppercase and it will return one new string.

let myName="devadharshini"
let upper = myName.toUpperCase()
console.log(myName.toUpperCase());
console.log(upper);
console.log(myName);

// 2.toLowerCase()-->used to convert any string into lowercase and it will return one new string.
...
// 3.indexOf()-->used to know the index of the given character in the string and it will take the first occurance of the given character and if the character is not present it will give -1

console.log(address.indexOf('N'));
console.log(address.indexOf('n'));

// 4.lastIndexOf()--> it will give the last occurance index number of the given character from the string.

console.log(address.lastIndexOf('N'));

// 5.charAt()-->used to know the character present in the given index.

console.log(address.charAt(3));

//6.includes()-->used to know wheather the given string is present or not and if it is present it will return true otherwisee it will return false.
